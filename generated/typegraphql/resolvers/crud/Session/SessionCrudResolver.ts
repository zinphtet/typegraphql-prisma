...
export class SessionCrudResolver {
  ...
  async findFirstSessionOrThrow(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindFirstSessionOrThrowArgs): Promise<Session | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
  ...
  async getSession(@TypeGraphQL.Ctx() ctx: any, @TypeGraphQL.Info() info: GraphQLResolveInfo, @TypeGraphQL.Args() args: FindUniqueSessionOrThrowArgs): Promise<Session | null> {
    const { _count } = transformInfoIntoPrismaArgs(info);
